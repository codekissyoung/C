...
#define PFX_COMPANY_MATCH_QUEUE "company_match_queue:"

#define MAX_SCENICS_NUM_PER_COMPANY 8

/* 2016.08.16: 打赏服务相关索引和常量     */
...
/* 2016.10.26: 问答服务相关常量和索引.    */
#define MAX_QA_INVITED_NUM 5
#define MAX_QA_SCENIC_NUM 5
#define PFX_SCENIC2QA "scenic2qa"
#define PFX_USER2QA "user2qa"
#define PFX_Q2A "q2a"
#define PFX_USER2INVITEME "user2inviteme"
#define PFX_USER2ANSWERME "user2answerme"

#define PFX_Q2A_UID "q2a_uid"
#define PFX_Q2AWAITING_UID "q2awaiting_uid"
#define PFX_Q2FOLLOW "q2follow"

/* 一次请求，最多返回的问答数量 */
#define MAX_RET_QA_NUM   200
